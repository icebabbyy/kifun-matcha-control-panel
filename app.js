...
const powders = {
  ...
  haku_yame: { label: "Haku Yame Milk Whisk", stock: "Haku Yame Milk Whisk", priceAdd: 15, cost: 13.8333, note: "Haku Matcha · Yame 30g · ฿415" },
  haku_uji: { label: "Haku Uji Milk Whisk", stock: "Haku Uji Milk Whisk", priceAdd: 15, cost: 12.8333, note: "Haku Matcha · Uji 30g · ฿385" },
...
const defaultHomeAliases = {
  ...
  haku_yame: { name: "HAKU YAME", note: "Haku Matcha · Yame · นุ่มนวล" },
  haku_uji: { name: "HAKU UJI", note: "Haku Matcha · Uji · ชัดเจน" },
